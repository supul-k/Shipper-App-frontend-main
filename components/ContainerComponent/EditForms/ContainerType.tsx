...
const ContainerType = ({ setFormValues, editFormValues }: IProps) => {
  const checkBoxArray: ICheckBox = {
    value: "roro",
    label: "Is this a Roro?",
    isChecked: editFormValues.container_type === "roro" ? true : false,
  };
      ...
      <div>
        <div id={"dropDownin_transit"}>
          <Dropdown
            ...
            search
            selection
            value={editFormValues.in_transit}
